(function (global, factory) {
	...
	(global.cityList = global.cityList || {}, global.cityList.vue = factory());
...
var index = createCommonjsModule(function (module, exports) {
  (function (global, factory) {
      ...
      (function (global, factory) {
        ...
        function assertType(value, type) {
          ...
          if (simpleCheckRE.test(expectedType)) {
            valid = (typeof value === 'undefined' ? 'undefined' : _typeof$$1(value)) === expectedType.toLowerCase();
        ...
        var overlayOpt = { render: function render() {
            var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _vm.show ? _c('div', { staticClass: "bn-overlay", style: _vm.overlayStyle, on: { "click": _vm.handleClick } }) : _vm._e();
          }, staticRenderFns: [], _scopeId: 'data-v-d875e38c',
          props: {
            show: {
              type: Boolean,
              default: false
        ...
        /* eslint-disable */
        var Overlay = Vue$3.extend(overlayOpt);
    ...
    var Popup$1 = { render: function render() {
        var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('transition', { attrs: { "name": "popup-slide" } }, [_vm.open ? _c('div', { ref: "popup", staticClass: "popup-wrap" }, [_c('div', { staticClass: "title" }, [_vm._t("title"), _vm.showClose ? _c('div', { staticClass: "fn-button close", on: { "click": function click($event) {
              _vm.$emit('close');
            } } }) : _vm._e(), _c('div', { staticClass: "content" }, [_vm._t("content")], 2), _c('div', { staticClass: "footer" }, [_vm._t("footer")], 2)], 2)]) : _vm._e()]);
      }, staticRenderFns: [], _scopeId: 'data-v-25b55916',
      name: 'popup',
      mixins: [index],
      props: {
        showClose: {
...
var CascadeList = { render: function render() {
        var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', [_c('div', { staticClass: "pcr-wrap" }, _vm._l(_vm.lists, function (list, idx) {
            return _c('div', { directives: [{ name: "show", rawName: "v-show", value: list && list.length !== 0, expression: "list && list.length !== 0" }], class: { chosen: true, cur: _vm.currentShow === idx }, style: { 'max-width': _vm.pcrWidth }, on: { "click": function click($event) {
                        _vm.togglePrcType(idx);
                    } } }, [_c('span', { staticClass: "text" }, [_vm._v(_vm._s(_vm.currentSelect[idx] && _vm.currentSelect[idx].name || '请选择'))])]);
        })), _c('div', { ref: "regionWrap", staticClass: "region-wrap", style: { width: _vm.wrapWidth } }, _vm._l(_vm.lists, function (list, idx) {
            return _c('ul', { staticClass: "pcr-list", style: { width: _vm.innerWidth } }, _vm._l(list, function (item, index) {
                return _c('li', { key: item.id, class: { chosen: _vm.isCurrent(idx, item.id) }, on: { "click": function click($event) {
                            _vm.change(idx, item);
                        } } }, [_vm._v(_vm._s(item.name) + " "), _vm.isCurrent(idx, item.id) ? _c('i', { staticClass: "icon checked-icon" }) : _vm._e()]);
            }));
        }))]);
    }, staticRenderFns: [], _scopeId: 'data-v-27e9215c',
    name: 'cascade-list',
    props: {
        lists: {
            type: Array,
    ...
    watch: {
        lists: function lists(val) {
            var newList = val[this.currentShow + 1];
            if (newList) {
                if (newList.length === 0) {
    ...
    methods: {
        reset: function reset() {
            for (var i = this.currentShow, len = this.currentSelect.length; i < len; i++) {
                this.currentSelect.splice(i, 1, null);
            }
        },
        togglePrcType: function togglePrcType(idx) {
            this.currentShow = idx;
        },
        isCurrent: function isCurrent(idx, id) {
        ...
        change: function change(idx, item) {
...
Vue$3.component(index.name, index);
Vue$3.component(CascadeList.name, CascadeList);
var CityList$1 = { render: function render() {
        var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('popup', { attrs: { "open": _vm.show }, on: { "close": function close($event) {
                    _vm.$emit('close');
                } } }, [_c('div', { staticClass: "normal-title", slot: "title" }, [_vm._v("选择所在地区")]), _c('cascade-list', { attrs: { "lists": _vm.lists, "maxLevel": 4, "preChosen": _vm.chosenRegion }, on: { "nextLevel": _vm.getLevelData, "chosen-complete": _vm.onChosenComplete }, slot: "content" })], 1);
    }, staticRenderFns: [],
    name: 'city-list',
    props: {
        show: {
    ...
    methods: {
        getLevelData: function getLevelData(level, id) {
            this.$emit('nextLevel', level, id);
        },
        onChosenComplete: function onChosenComplete(chosen) {
