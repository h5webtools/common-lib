...
var bi = {
    env: 'test',
    options: {},
    init: function init(env, options) {
        this.env = env;
        this.options = assign(defaultOptions$1, options || {});
    },
    pageview: function pageview(ids, params) {
        this._track(ids, params);
    },
    event: function event(ids, params) {
        this._track(ids, params);
    },
    _track: function _track(ids, params) {
        if (!ids) {
            return;
        }
...
var mta = {
    ...
    init: function init(env, options) {
        ...
        this.env = env;
        this.options = assign(defaultOptions$2, options || {});
    ...
    createClass(Bimta, [{
        ...
        value: function _initPageviewReport() {
            ...
            if (els.length > 0) {
                window.setTimeout(function () {
                    _this._dataAttrReport('pageview', els[0], [alias.ea, alias.eb, alias.visit, alias.para]);
                }, 0);
            }
        }
        ...
        value: function _initEventReport() {
            ...
            document.body.addEventListener('click', function (e) {
                window.setTimeout(function () {
                    var el = e.target;
                    var dataAttribute = _this2.dataAttribute;
                    var alias = dataAttribute.alias;

                    _this2._dataAttrReport('event', el, [alias.ea, alias.eb, alias.ec, alias.para]);
                }, 0);
            }, true);
        }
...
//# sourceMappingURL=bimta.dev.js.map
