(function (global, factory) {
	...
	(global.dialog = global.dialog || {}, global.dialog.vue = factory());
...
var Dialog$1 = { render: function render() {
        var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _vm.open ? _c('div', { ref: "popup", staticClass: "dialog-wrap" }, [_vm.title ? _c('div', { staticClass: "dialog-title", style: _vm.dialogTitleStyle }, [_vm._v(_vm._s(_vm.title) + " "), _vm.showClose ? _c('span', { staticClass: "close-wrap", on: { "click": _vm.close } }, [_vm._v("✕")]) : _vm._e()]) : _vm._e(), _c('div', { staticClass: "dialog-content" }, [_vm._t("content")], 2), _c('div', { staticClass: "dialog-btn-wrap" }, [_vm._t("buttons")], 2)]) : _vm._e();
    }, staticRenderFns: [],
    name: 'common-dialog',
    mixins: [index],
    props: {
    ...
    computed: {
        dialogTitleStyle: function dialogTitleStyle() {
            var style = {};
            for (var i in this.titleStyle) {
