...
window.Zepto = Zepto$2;
window.$ === undefined && (window.$ = Zepto$2);
...
(function ($) {
  ...
  function setup(__eventMap) {
    ...
    eventMap = __eventMap && 'down' in __eventMap ? __eventMap : 'ontouchstart' in document ? { 'down': 'touchstart', 'up': 'touchend',
      'move': 'touchmove', 'cancel': 'touchcancel' } : 'onpointerdown' in document ? { 'down': 'pointerdown', 'up': 'pointerup',
      'move': 'pointermove', 'cancel': 'pointercancel' } : 'onmspointerdown' in document ? { 'down': 'MSPointerDown', 'up': 'MSPointerUp',
