(function (global, factory) {
	...
	(global.AddrList = global.AddrList || {}, global.AddrList.vue = factory());
...
var AddrList$1 = { render: function render() {
        var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', [_c('popup', { attrs: { "open": _vm.show }, on: { "close": function close($event) {
                    _vm.$emit('close');
                } } }, [_c('template', { slot: "title" }, [_vm.full ? _c('div', { staticClass: "fn-button back" }, [_c('span', { on: { "click": _vm.manageAddressList } }, [_vm._v("管理")])]) : _vm._e(), _c('div', { staticClass: "normal-title" }, [_vm._v("配送至")])]), _c('div', { staticClass: "address-content", slot: "content" }, [_vm._l(_vm.infoList, function (addr, index$$1) {
            return _c('div', { key: "addr.info_id", class: { 'address-item': true, chosen: _vm.currentInfoId == addr.info_id }, on: { "click": function click($event) {
                        _vm.choseAddress(addr.info_id);
                    } } }, [_vm.full ? _c('p', [_vm._v(_vm._s(addr.name) + " "), _c('span', { staticClass: "ui-pl-20" }, [_vm._v("    " + _vm._s(addr.tel))])]) : _vm._e(), _c('p', [_vm._v(_vm._s(addr.fullAddress))]), _c('i', { staticClass: "icon checked-icon" })]);
        }), _vm.full ? _c('div', { staticClass: "address-item add-more-addr", on: { "click": _vm.addMoreAddress } }, [_c('span', { staticClass: "icon mod-address-plus gray" }), _vm._v("新增收货地址")]) : _c('div', { staticClass: "address-item add-more-addr", on: { "click": _vm.addOtherAddress } }, [_c('span', { staticClass: "icon mod-address-plus gray" }), _vm._v("填写其他地址")])], 2)], 2)], 1);
