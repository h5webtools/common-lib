...
Fullpage.prototype.update = function () {
  ...
  for (var _i = 0; _i < this.pageEles.length; _i++) {
    var _pageEle = this.pageEles[_i];
    _pageEle.style.height = this.height + 'px';
  }
...
Fullpage.prototype.moveTo = function (next, anim) {
  ...
  if (next !== cur) {
    var flag = that.o.beforeChange.call(that, { next: next, cur: cur });
...
//# sourceMappingURL=fullpage.dev.js.map
