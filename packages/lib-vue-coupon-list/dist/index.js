(function (global, factory) {
	...
	(global.couponList = global.couponList || {}, global.couponList.vue = factory());
...
var CouponItem = { render: function render() {
        var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { class: _vm.classObj, on: { "click": function click($event) {
                    _vm.onClick(_vm.cid);
                } } }, [_c('div', { staticClass: "coupons-up" }, [_c('div', { class: _vm.currentValue.classes }, [_c('p', { staticClass: "coupons-value" }, [_vm._v(_vm._s(_vm.value))]), _c('p', { staticClass: "coupons-unit" }, [_vm._v(_vm._s(_vm.unit))])]), _c('div', { staticClass: "up-right" }, [_c('p', { staticClass: "coupons-title" }, [_vm._v(_vm._s(_vm.name))]), _c('p', { staticClass: "coupons-useinfo" }, [_vm._v(_vm._s(_vm.useInfo))]), _c('p', { staticClass: "coupons-valid" }, [_vm._v("有效期至" + _vm._s(_vm.expired_time))])])]), _c('div', { staticClass: "coupons-down" }, [_vm._v(_vm._s(_vm.usage))])]);
    }, staticRenderFns: [], _scopeId: 'data-v-cd1f6c42',
    name: 'coupon-item',
    props: {
        active: {
            type: Boolean,
...
var CouponList$1 = { render: function render() {
        var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('popup', { attrs: { "open": _vm.show, "showClose": false }, on: { "close": _vm.closecoupon } }, [_c('div', { staticClass: "coupons-head", on: { "click": _vm.closecoupon }, slot: "title" }, [_vm._v(_vm._s(_vm.title))]), _c('div', { staticClass: "coupons-content", slot: "content" }, [_vm._l(_vm.list, function (item, idx) {
            return _c('coupon-item', _vm._b({ key: item.cid, attrs: { "active": item.cid == _vm.cid }, on: { "click-coupon": _vm.changecoupon } }, 'coupon-item', item));
        }), _c('div', { class: { 'coupons-nottouse': true, active: _vm.cid == 0 }, on: { "click": function click($event) {
                    _vm.changecoupon('0');
                } } }, [_vm._v(_vm._s(_vm.notUseDes))])], 2)]);
    }, staticRenderFns: [],
    name: 'coupon-list',
    components: {
        Popup: index,
    ...
    methods: {
        ...
        changecoupon: function changecoupon(cid) {
